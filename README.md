...
Refers to `.scss` files within the `_sass` directory that define the theme's styles.
  ...
  - `ludwig.scss` &mdash; The core file imported by preprocessed `main.scss`, it defines the variable defaults for the theme and also further imports sass partials to supplement itself.
  - `ludwig/_base.scss` &mdash; Resets and defines base styles for various HTML elements.
  - `ludwig/_layout.scss` &mdash; Defines the visual style for various layouts.
  - `ludwig/_syntax-highlighting.scss` &mdash; Defines the styles for syntax-highlighting.
