...
<div class="grid-item">
  ...
  <div class="copy-left">
    ...
    <p>The bold color palette of red, black and white bring clarity and simplicity to each page. On the homepage, the logo is enlarged and animated to form abstract shapes while a glimpse of the studio is visible through each letter form.</p>
    </div>
  </div>
</div>
...
<div class="grid-item">
  <div class="copy-block split revealblock">
  <div class="copy-left">
    <p>The interface for each case study is minimal, allowing the work to show through. Blog posts and pages about Torque’s services are specifically designed to accommodate updates.</p>
    </div>
  </div>
</div>
